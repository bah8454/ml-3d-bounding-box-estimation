...
def main():
    """Trains a model with the hardcoded hyperparameters found below.  Saves a model weight file after every epoch.  Loss is displayed every 10 batches.
    """
    ...
    # Comment the above line and uncomment this to perform smooth l1 loss instead.
    #dim_loss_func = nn.SmoothL1Loss().cuda()
